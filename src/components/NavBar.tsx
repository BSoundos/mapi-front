...
const Navbar = () => {
  return (
    <div className="bg-mapi-neutral-2 border-b-2 border-corner-1-300">
      <div style={{ margin: '0 60px' }} className="flex items-center justify-between p-4">
        ...
        <div className="flex items-center space-x-6">
          ...
          <div className="flex items-center space-x-3">
              <div className="h-15 w-15 rounded-full bg-gray-400 flex items-center">
                <img src="src/assets/customer.png" alt="User" className="h-full w-full rounded-full" />
              </div>
              <div>
          ...
          <button className="bg-mapi-secondary-1 text-white opacity-75 px-4 py-2 rounded-md border border-corner-1-300 border-0.5 text-sm">
            Logout
          </button>
        </div>
      </div>
