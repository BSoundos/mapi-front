              ...
              {filteredProviders.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((provider, index) => (
                <TableRow key={provider.id} style={{ backgroundColor: '#081028' }}>
                  ...
                  <TableCell style={{
                    ...
                    <Link to={`/admin/providers/details/${provider.username}`} className="inline-block bg-primary-dark text-white no-underline px-4 py-2 border border-gray-600 rounded-md ml-2">
                      Details
                    </Link>
